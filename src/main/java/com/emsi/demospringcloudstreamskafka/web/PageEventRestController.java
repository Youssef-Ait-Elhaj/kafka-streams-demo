package com.emsi.demospringcloudstreamskafka.web;

import com.emsi.demospringcloudstreamskafka.entities.PageEvent;
    ...
    public Flux<Map<String, Long>> analytics() {
        return Flux.interval(Duration.ofSeconds(1)).map(sequence->{
           Map<String, Long> stringLongMap = new HashMap<>();
            ReadOnlyWindowStore<String, Long> stats = interactiveQueryService.getQueryableStore("page-count",
